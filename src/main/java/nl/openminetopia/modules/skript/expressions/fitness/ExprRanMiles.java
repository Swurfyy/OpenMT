...
public class ExprRanMiles extends SimpleExpression<Integer> {

    static {
        Skript.registerExpression(ExprRanMiles.class, Integer.class, ExpressionType.COMBINED, "[the] (omt|openminetopia) fitness ranmiles of %player%");
    }

...
Deze fork van OpenMinetopia is een open-source project voor de Minetopia community. 
Het doel van dit project is om een goed onderhouden Minetopia plugin te ontwikkelen die voor iedereen toegankelijk is.
De verschillen tussen de originele versie, met deze versie zijn als volgt:
- Speedboots feature.
- Basis features zoals fitheid & level zijn verwijderd.
- Een belasting feature.
- Andere handeling bij "/plot transfer", zodat spelers dit zelf kunnen.
- Pin terminals
- WoZ waardes per pand
- Anti Elytra velocity damage
- En meer.
